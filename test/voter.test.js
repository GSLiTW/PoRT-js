...
*/
  ...
  const voter = new Voter(3004, wallet, chain);
  // ///////modify
  const txspool = new Pending_Txn_Pool();
  txspool.addTxs(createtxs(2));
  const tempBlock = new Block(2, txspool.transactions, chain.chain[0].hash, Tree);
  ...
  test('verify signature', () => {
    const tx_hash = '43a1a360188faaa2b227c1133d66e155c240816b33d6cba682e9ab27dbc77012';
    // let privateKey = "d756e19af3303ea489eb5a8c5a44ac10a38317fc7ee85ec599bf158232601aa8";
    const keyPair = ecdsa.keyFromPrivate('d756e19af3303ea489eb5a8c5a44ac10a38317fc7ee85ec599bf158232601aa8');
    const privateKey = keyPair.getPrivate('hex');
    const publicKey = '04f586957689dd425776cb9dabf6c8fa5b311a175ede33e1e85b54c931b6d8fb14f8085a1b095e6886a25bbe346da08eb05e605f100e67272da7dac4d4c43d60bc';
    const signature = ecdsa.sign(tx_hash, privateKey, 'hex', {canonical: true});
    const hexToDecimal = (x) => ecdsa.keyFromPrivate(x, 'hex').getPrivate().toString(10);
    const pubKeyRecovered = ecdsa.recoverPubKey(
